...
def criar_banco_dados_ferias(dados):
    try:
        df = pd.read_excel('/Users/fabiomachida/Comunidade DS/repos/poupatempo/extrato_ponto/dataset/banco_dados_ferias.xlsx')
    ...
    df.to_excel('/Users/fabiomachida/Comunidade DS/repos/poupatempo/extrato_ponto/dataset/banco_dados_ferias.xlsx', index=False)
